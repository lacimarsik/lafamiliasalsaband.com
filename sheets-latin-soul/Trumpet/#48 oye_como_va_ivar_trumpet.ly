...
\header {
    title = "#48 Oye Como Va (Latin Soul: Ami)"
        instrument = "trumpet"
    composer = "by Santana"
...
\relative c'' {
  ...
  \tempo "Cha Cha" 4 = 120
	...
	\set Score.skipBars = ##t R1*4 ^\markup { "Bass +Piano Intro" } |
	...
	a,4 \f ^\markup { "Half Break (does not need to be though)" } a8 a r a a a |
	r a a a d a e' r | \break

	\repeat volta 2 {
	  a,8  \tenuto \f ^\markup { "Brass 2 (can be just solos instead)" }  a\tenuto  c \tenuto  e \tenuto g \tenuto e \tenuto  g \tenuto  fis -.  |
	  r d -.  r2. |
	...
	\repeat volta 2 {
	  c'8  \tenuto \f ^\markup { "Brass 3 (can be put at the end of solo)" }  c \tenuto  g -.  r c \tenuto g -.  r  c -.  |
	  r fis, -.  r4 c'8 c fis, r |
	  c'  \tenuto \f   c \tenuto  g -.  r c \tenuto g -.  r  c -.  |
	  r fis, -.  r4 c'8 c fis, r |
	}
